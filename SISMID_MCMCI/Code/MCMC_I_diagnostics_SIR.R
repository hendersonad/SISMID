...
source("/Users/AHenderson/OneDrive - London School of Hygiene and Tropical Medicine/PhD/SISMID/SISMID_MCMCI/Code/MCMC_I_SIRaugmentation_functionsonly.R")
...
coda.gibbs.chain = mcmc(cbind(beta=mcmc.sample$beta[101:mcmc.size],gamma=mcmc.sample$gamma[101:mcmc.size]))
...
##' BETA = 52
##' GAMMA = 60 
##' SO we need to extend the chain A LOT from 600 - say 6000
