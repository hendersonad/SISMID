...
remtimes    = readdata() # vector of the removal times - the only observed data
test <- initializedata(remtimes) ## initialises the data - initial values for infection times 
mcmc.size   = 600
...
##' traces behave 'relatively' nicely
...
# just a toy example because no latency etc....
