...
par(mfrow=c(2,2))
  f=0.0; e=0.9; #change f and e from zero to some value between 0 and 1 to simulate different types and strengths of hypotehtical IFN action
  f=0.9; e=0.0;
  f=0.5; e=0.5;
  f=0.9; e=0.9;
  ...
  #plot results
  plot(odeoutput1[,1],odeoutput1[,4],type="l",xlab="time (days)",ylab="Virus load",col=3,lwd=2,log="y",xlim=c(0,tmax),ylim=c(1e0,1e7))
