...
{ 
	  ...
	  #these are the 3 differential equations
		...
		dVirdt=p*Itc-clear*Vir ## ignoring loss of bUV in this compartment
...
###################################################################
  ...
  parameters=c(b,delta,p,clear); #vector of parameters which is sent to the ODE function
	...
	timevec=seq(0,20,0.01); #vector of times for which integration is evaluated (from 0 to 10 days in steps of 0.1)
...
## so as dt decreases basically simulating what ODE package is doing and results are more closely aligned
